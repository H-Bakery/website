...
server.listen(PORT, () => {
  ...
  logger.info(
    '  GET /dashboard/sales-summary - Get sales analytics (authenticated)'
  )
  logger.info(
    '  GET /dashboard/production-overview - Get production analytics (authenticated)'
  )
  logger.info(
    '  GET /dashboard/revenue-analytics - Get revenue analytics (authenticated)'
  )
  logger.info(
    '  GET /dashboard/order-analytics - Get order analytics (authenticated)'
  )
  logger.info(
    '  GET /dashboard/product-performance - Get product performance (authenticated)'
  )
  logger.info(
    '  GET /dashboard/daily-metrics - Get daily metrics (authenticated)'
  )
  ...
  logger.info(
    '  POST /api/workflows/validate - Validate workflow structure (authenticated)'
  )
  logger.info(
    '  POST /api/inventory - Create new inventory item (authenticated)'
  )
  logger.info('  GET /api/inventory - Get all inventory items (authenticated)')
  logger.info(
    '  GET /api/inventory/:id - Get inventory item by ID (authenticated)'
  )
  logger.info(
  ...
  logger.info(
    '  GET /api/inventory/needs-reorder - Get items needing reorder (authenticated)'
  )
  logger.info(
    '  POST /api/inventory/bulk-adjust - Bulk adjust stock levels (authenticated)'
  )
  logger.info(
    '  GET /api/notifications - Get all notifications for user (authenticated)'
  )
  logger.info(
    '  GET /api/notifications/:id - Get single notification (authenticated)'
  )
  ...
  logger.info(
    '  POST /api/notifications/bulk - Bulk create notifications (admin only)'
  )
  logger.info(
    '  GET /api/preferences - Get user notification preferences (authenticated)'
  )
  logger.info(
    '  PUT /api/preferences - Update notification preferences (authenticated)'
  )
  logger.info(
    '  POST /api/preferences/reset - Reset preferences to defaults (authenticated)'
  )
  logger.info(
    '  GET /api/templates - Get all notification templates (authenticated)'
  )
  logger.info('  GET /api/templates/:key - Get template by key (authenticated)')
  logger.info(
    '  POST /api/templates/:key/preview - Preview template with variables (authenticated)'
  )
  ...
  logger.info(
    '  PUT /api/production/schedules/:id - Update production schedule (authenticated)'
  )
  logger.info(
  ...
  logger.info(
    '  POST /api/production/batches/:id/start - Start production batch (authenticated)'
  )
  logger.info(
    '  GET /api/production/batches/:batchId/steps - Get batch steps (authenticated)'
  )
  logger.info(
    '  PUT /api/production/steps/:id - Update production step (authenticated)'
  )
  logger.info(
    '  POST /api/production/steps/:id/complete - Complete production step (authenticated)'
  )
  logger.info(
    '  GET /api/production/analytics - Get production analytics (authenticated)'
  )
  logger.info(
    '  POST /api/reports/generate - Generate sales report (authenticated)'
  )
  logger.info('  GET /api/reports/:id - Get report details (authenticated)')
  logger.info('  GET /api/reports/download/:token - Download report file')
  logger.info(
    '  POST /api/reports/schedule - Create report schedule (authenticated)'
  )
  logger.info(
    '  GET /api/reports/schedules - Get all schedules (authenticated)'
  )
  logger.info(
    '  PUT /api/reports/schedule/:id - Update schedule (authenticated)'
  )
  logger.info(
    '  DELETE /api/reports/schedule/:id - Delete schedule (authenticated)'
  )
  logger.info(
    '  GET /api/reports/storage/stats - Get storage statistics (authenticated)'
  )
  logger.info(
    '  POST /api/reports/storage/cleanup - Clean up old files (authenticated)'
  )
})
