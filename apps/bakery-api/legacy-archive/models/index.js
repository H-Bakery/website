...
const NotificationPreferences = NotificationPreferencesModel(
  sequelize,
  DataTypes
)
...
User.hasMany(ProductionSchedule, {
  foreignKey: 'createdBy',
  as: 'CreatedSchedules',
})
User.hasMany(ProductionSchedule, {
  foreignKey: 'approvedBy',
  as: 'ApprovedSchedules',
})
...
async function syncDatabase() {
  logger.warn(
    'syncDatabase() is deprecated. Use initializeDatabaseWithMigrations() instead.'
  )
