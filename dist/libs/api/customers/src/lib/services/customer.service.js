...
var CustomerService = /** @class */ (function () {
    ...
    CustomerService.prototype.createCustomer = function (customerData) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var hashedPassword, customer, _a, password, customerWithoutPassword, error_1;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        core_1.logger.info("Creating new customer: ".concat(customerData.username));
                        return [4 /*yield*/, bcrypt.hash(customerData.password, 10)];
                    case 1:
                        hashedPassword = _b.sent();
                        return [4 /*yield*/, customer_model_1.Customer.create(tslib_1.__assign(tslib_1.__assign({}, customerData), { password: hashedPassword }))];
                    case 2:
                        customer = _b.sent();
                        _a = customer.toJSON(), password = _a.password, customerWithoutPassword = tslib_1.__rest(_a, ["password"]);
                        core_1.logger.info("Customer created successfully: ".concat(customer.id));
        ...
        return tslib_1.__awaiter(this, arguments, void 0, function (filters) {
            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        if (filters.search) {
                            where[sequelize_1.Op.or] = [
                                { username: (_a = {}, _a[sequelize_1.Op.like] = "%".concat(filters.search, "%"), _a) },
                                { email: (_b = {}, _b[sequelize_1.Op.like] = "%".concat(filters.search, "%"), _b) },
                                { firstName: (_c = {}, _c[sequelize_1.Op.like] = "%".concat(filters.search, "%"), _c) },
                                { lastName: (_d = {}, _d[sequelize_1.Op.like] = "%".concat(filters.search, "%"), _d) }
                            ];
                        }
                        core_1.logger.info("Retrieving customers with filters: ".concat(JSON.stringify(filters)));
                    ...
                    case 1:
                        customers = _e.sent();
                        core_1.logger.info("Retrieved ".concat(customers.length, " customers"));
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_3 = _a.sent();
                        core_1.logger.error("Error retrieving customer ".concat(id, ":"), error_3);
                        throw error_3;
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        core_1.logger.info("Retrieving customer by username: ".concat(username));
                        return [4 /*yield*/, customer_model_1.Customer.findOne({
                                where: { username: username }
                            })];
                    case 1:
                        customer = _a.sent();
                        if (!customer) {
                            core_1.logger.warn("Customer not found with username: ".concat(username));
                            return [2 /*return*/, null];
                        }
                    ...
                    case 2:
                        error_4 = _a.sent();
                        core_1.logger.error("Error retrieving customer by username ".concat(username, ":"), error_4);
                        throw error_4;
                    case 3: return [2 /*return*/];
                }
            });
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        password = updateData.password, safeUpdateData = tslib_1.__rest(updateData, ["password"]);
                        return [4 /*yield*/, customer_model_1.Customer.findByPk(id)];
                    case 1:
                        customer = _a.sent();
                        if (!customer) {
                    ...
                    case 4:
                        error_5 = _a.sent();
                        core_1.logger.error("Error updating customer ".concat(id, ":"), error_5);
                        throw error_5;
     ...
     */
    CustomerService.prototype.updatePassword = function (id, currentPassword, newPassword) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        customer = _a.sent();
                        if (!customer) {
                            core_1.logger.warn("Customer not found for password update: ".concat(id));
                    ...
                    case 2:
                        ...
                        if (!validPassword) {
                            core_1.logger.warn("Invalid current password for customer: ".concat(id));
                            return [2 /*return*/, false];
                        }
                    ...
                    case 4:
                        _a.sent();
                        core_1.logger.info("Password updated successfully for customer: ".concat(id));
                        return [2 /*return*/, true];
                    case 5:
                        error_6 = _a.sent();
                        core_1.logger.error("Error updating password for customer ".concat(id, ":"), error_6);
                        throw error_6;
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        customer = _a.sent();
                        if (!customer) {
                            core_1.logger.warn("Customer not found for deactivation: ".concat(id));
                            return [2 /*return*/, false];
                        }
                    ...
                    case 3:
                        error_7 = _a.sent();
                        core_1.logger.error("Error deactivating customer ".concat(id, ":"), error_7);
                        throw error_7;
                    case 4: return [2 /*return*/];
                }
            });
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        customer = _a.sent();
                        if (!customer) {
                            core_1.logger.warn("Customer not found for reactivation: ".concat(id));
                            return [2 /*return*/, false];
                        }
                    ...
                    case 3:
                        error_8 = _a.sent();
                        core_1.logger.error("Error reactivating customer ".concat(id, ":"), error_8);
                        throw error_8;
                    case 4: return [2 /*return*/];
                }
            });
    ...
    CustomerService.prototype.getCustomerStats = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, totalCustomers, activeCustomers, adminCount, staffCount, userCount, stats, error_9;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        _a = _b.sent(), totalCustomers = _a[0], activeCustomers = _a[1], adminCount = _a[2], staffCount = _a[3], userCount = _a[4];
                        stats = {
                    ...
                    case 2:
                        error_9 = _b.sent();
                        core_1.logger.error('Error retrieving customer statistics:', error_9);
                        throw error_9;
                    case 3: return [2 /*return*/];
                }
            });
     ...
     */
    CustomerService.prototype.validateCredentials = function (username, password) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        core_1.logger.info("Validating credentials for user: ".concat(username));
                    ...
                    case 2:
                        ...
                        core_1.logger.info("Credentials validated for user: ".concat(username));
                        return [2 /*return*/, customer];
                    case 3:
                        error_10 = _a.sent();
                        core_1.logger.error("Error validating credentials for ".concat(username, ":"), error_10);
                        throw error_10;
                    case 4: return [2 /*return*/];
                }
            });
