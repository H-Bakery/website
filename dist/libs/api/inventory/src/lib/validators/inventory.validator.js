...
exports.bulkStockAdjustmentRules = exports.stockAdjustmentRules = exports.inventoryDeleteRules = exports.inventoryUpdateRules = exports.inventoryCreationRules = void 0;
var express_validator_1 = require("express-validator");
/**
 * Validation rules for creating an inventory item
 */
var inventoryCreationRules = function () { return [
 ...
 */
var inventoryUpdateRules = function () { return [
 ...
 */
var inventoryDeleteRules = function () { return [
    (0, express_validator_1.param)('id')
        .notEmpty().withMessage('Inventory item ID is required')
        .isInt({ min: 1 }).withMessage('Inventory item ID must be a positive integer')
]; };
 ...
 */
var stockAdjustmentRules = function () { return [
    (0, express_validator_1.param)('id')
        .notEmpty().withMessage('Inventory item ID is required')
        .isInt({ min: 1 }).withMessage('Inventory item ID must be a positive integer'),
 ...
 */
var bulkStockAdjustmentRules = function () { return [
