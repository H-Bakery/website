...
export declare class InventoryService {
     ...
     */
    updateItemDetails(id: number, updateData: Partial<InventoryCreationAttributes>): Promise<Inventory | null>;
    /**
     ...
     * @returns The updated inventory item
     */
    adjustStockLevel(id: number, change: number, reason?: string | null): Promise<Inventory | null>;
    /**
     ...
     */
    bulkAdjustStock(adjustments: StockAdjustment[], reason?: string): Promise<BulkAdjustmentResults>;
}
export {};
