      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 2, , 3])
            core_1.logger.info(
              'Creating new inventory item: '.concat(itemData.name)
            )
            return [4 /*yield*/, inventory_model_1.Inventory.create(itemData)]
          case 1:
            item = _a.sent()
            core_1.logger.info(
              'Inventory item created successfully: '.concat(item.id)
            )
        ...
        switch (_f.label) {
          case 0:
              ...
              where[sequelize_1.Op.and] = [
                {
                  quantity:
                    ((_a = {}),
                    (_a[sequelize_1.Op.lte] =
                      inventory_model_1.Inventory.sequelize.col(
                        'lowStockThreshold'
                      )),
                    _a),
                },
            ...
            if (filters.supplier) {
              where.supplier =
                ((_e = {}),
                (_e[sequelize_1.Op.like] = '%'.concat(filters.supplier, '%')),
                _e)
            }
            core_1.logger.info(
              'Retrieving inventory items with filters: '.concat(
                JSON.stringify(filters)
              )
            )
            return [
              4 /*yield*/,
              inventory_model_1.Inventory.findAll({
                where: where,
                order: [['name', 'ASC']],
              }),
            ]
          case 1:
            items = _f.sent()
            core_1.logger.info(
              'Retrieved '.concat(items.length, ' inventory items')
            )
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            error_3 = _a.sent()
            core_1.logger.error(
              'Error retrieving inventory item '.concat(id, ':'),
              error_3
            )
            throw error_3
          case 3:
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            core_1.logger.info(
              'Updating inventory item: '
                .concat(id, ' - ')
                .concat(JSON.stringify(updateData))
            )
            ;(quantity = updateData.quantity),
              (safeUpdateData = tslib_1.__rest(updateData, ['quantity']))
            return [4 /*yield*/, inventory_model_1.Inventory.findByPk(id)]
          case 1:
            item = _a.sent()
            if (!item) {
              core_1.logger.warn(
                'Inventory item not found for update: '.concat(id)
              )
              return [2 /*return*/, null]
            }
          ...
          case 2:
            _a.sent()
            core_1.logger.info(
              'Inventory item updated successfully: '.concat(id)
            )
            return [2 /*return*/, item]
          case 3:
            error_4 = _a.sent()
            core_1.logger.error(
              'Error updating inventory item '.concat(id, ':'),
              error_4
            )
            throw error_4
          case 4:
        ...
        return tslib_1.__generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              _a.trys.push([0, 5, , 6])
              core_1.logger.info(
                'Adjusting stock for item '
                  .concat(id, ' - change: ')
                  .concat(change, ', reason: ')
                  .concat(reason)
              )
              return [4 /*yield*/, inventory_model_1.Inventory.findByPk(id)]
            case 1:
              ...
              if (!item) {
                core_1.logger.warn(
                  'Inventory item not found for stock adjustment: '.concat(id)
                )
                return [2 /*return*/, null]
              }
              ...
              if (newQuantity < 0) {
                error = new Error(
                  'Insufficient stock. Available: '
                    .concat(oldQuantity, ', Requested change: ')
                    .concat(change)
                )
            ...
            case 2:
              ...
              core_1.logger.info(
                'Stock adjusted for item '
                  .concat(id, ' - old: ')
                  .concat(oldQuantity, ', new: ')
                  .concat(item.quantity, ', change: ')
                  .concat(change, ', reason: ')
                  .concat(reason)
              )
              if (
              ...
              return [
                4 /*yield*/,
                (0, notifications_1.createLowInventoryNotification)(
                  item.name,
                  item.quantity,
                  item.lowStockThreshold
                ),
            ...
            case 5:
              ...
              if (error_5.code === 'INSUFFICIENT_STOCK') {
                ...
                core_1.logger.error(
                  'Error adjusting stock for item '.concat(id, ':'),
                  error_5
                )
              }
              throw error_5
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (!item) {
              core_1.logger.warn(
                'Inventory item not found for deletion: '.concat(id)
              )
          ...
          case 3:
            error_6 = _a.sent()
            core_1.logger.error(
              'Error deleting inventory item '.concat(id, ':'),
              error_6
            )
            throw error_6
          case 4:
      ...
      return tslib_1.__generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            items = _c.sent()
            core_1.logger.info(
              'Found '.concat(items.length, ' items needing reorder')
            )
            return [2 /*return*/, items]
          case 2:
            error_7 = _c.sent()
            core_1.logger.error(
              'Error retrieving items needing reorder:',
              error_7
            )
            throw error_7
          case 3:
      ...
      return tslib_1.__generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            items = _c.sent()
            core_1.logger.info(
              'Found '.concat(items.length, ' low stock items')
            )
            return [2 /*return*/, items]
          case 2:
            error_8 = _c.sent()
        ...
        return tslib_1.__generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 1:
              _a.trys.push([1, 8, , 9])
              core_1.logger.info(
                'Starting bulk stock adjustment for '
                  .concat(adjustments.length, ' items - reason: ')
                  .concat(reason)
              )
            ...
            case 3:
              ...
              return [
                4 /*yield*/,
                this.adjustStockLevel(adjustment.id, adjustment.change, reason),
              ]
            case 4:
              item = _a.sent()
              if (item) {
            ...
            case 7:
              core_1.logger.info(
                'Bulk stock adjustment completed - total: '
                  .concat(adjustments.length, ', successful: ')
                  .concat(results.successful.length, ', failed: ')
                  .concat(results.failed.length)
              )
