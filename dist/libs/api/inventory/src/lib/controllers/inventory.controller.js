...
var InventoryController = /** @class */ (function () {
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 2, , 3])
            core_1.logger.info(
              'Creating new inventory item: ' + JSON.stringify(req.body)
            )
            return [
              4 /*yield*/,
              InventoryController.inventoryService.createItem(req.body),
            ]
          case 1:
            item = _a.sent()
            res.status(201).json({
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 2, , 3])
            core_1.logger.info(
              'Retrieving inventory items: ' + JSON.stringify(req.query)
            )
            filters = {
            ...
            return [
              4 /*yield*/,
              InventoryController.inventoryService.getAllItems(filters),
            ]
          case 1:
            items = _a.sent()
            ...
            endIndex = page * limit
            paginatedItems =
              limit < items.length ? items.slice(startIndex, endIndex) : items
            res.json({
              success: true,
              data: paginatedItems,
              pagination: {
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              InventoryController.inventoryService.getItemById(parseInt(id)),
            ]
          case 1:
            item = _a.sent()
            if (!item) {
          ...
          case 2:
            error_3 = _a.sent()
            core_1.logger.error(
              'Error retrieving inventory item '.concat(req.params['id'], ':'),
              error_3
            )
            res.status(500).json({
              success: false,
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              InventoryController.inventoryService.updateItemDetails(
                parseInt(id),
                req.body
              ),
            ]
          ...
          case 2:
            error_4 = _a.sent()
            core_1.logger.error(
              'Error updating inventory item '.concat(req.params['id'], ':'),
              error_4
            )
      ...
      return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              InventoryController.inventoryService.adjustStockLevel(
                parseInt(id),
                change,
                reason
              ),
          ...
          case 2:
            error_5 = _b.sent()
            core_1.logger.error(
              'Error adjusting stock for item '.concat(req.params['id'], ':'),
              error_5
            )
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              InventoryController.inventoryService.deleteItem(parseInt(id)),
            ]
          case 1:
            deleted = _a.sent()
            if (!deleted) {
          ...
          case 2:
            error_6 = _a.sent()
            core_1.logger.error(
              'Error deleting inventory item '.concat(req.params['id'], ':'),
              error_6
            )
            res.status(500).json({
              success: false,
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              InventoryController.inventoryService.getItemsNeedingReorder(),
            ]
          case 1:
            items = _a.sent()
            res.json({
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              InventoryController.inventoryService.getLowStockItems(),
            ]
          case 1:
            items = _a.sent()
            res.json({
        ...
        switch (_b.label) {
          case 0:
            ...
            ;(_a = req.body),
              ...
              (reason = _a.reason)
            core_1.logger.info(
              'Processing bulk stock adjustment - count: '
                .concat(
                  adjustments === null || adjustments === void 0
                    ? void 0
                    : adjustments.length,
                  ', reason: '
                )
            ...
            return [
              4 /*yield*/,
              InventoryController.inventoryService.bulkAdjustStock(
                adjustments,
                reason
              ),
            ]
          case 1:
            ...
            res.json({
              ...
              message: 'Bulk adjustment completed: '
                .concat(results.successful.length, ' successful, ')
                .concat(results.failed.length, ' failed'),
            })
            return [3 /*break*/, 3]
          case 2:
            error_9 = _b.sent()
  ...
  InventoryController.inventoryService =
    new inventory_service_1.InventoryService()
