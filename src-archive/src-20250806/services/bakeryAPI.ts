...
const bakeryAPI = {
          ...
          result.data.topProducts.forEach((product: any, index: number) => {
            ...
            for (let i = 0; i < daysToGenerate; i++) {
              ...
              productionData.push({
                ...
                product_name: product.name,
                quantity_produced: Math.ceil(
                  product.totalQuantity / daysToGenerate
                ),
  ...
  getCashHistory: async (): Promise<CashEntry[]> => {
    try {
      ...
      for (let i = 0; i < 30; i++) {
        ...
        const amount =
          Math.round((baseAmount + (Math.random() - 0.5) * 100) * 100) / 100
  ...
  addUnsoldProduct: async (
    ...
    try {
      ...
      if (!response.ok) {
        ...
        const errorData = await response.json().catch(() => ({}))
        throw new Error(
          errorData.error || 'Failed to save unsold product entry'
        )
      }
  ...
  getUnsoldProductsSummary: async (): Promise<any[]> => {
    try {
      ...
      console.warn(
        'Backend unavailable, using mock summary data for development'
      )
      const mockSummary = [
        {
          productId: 1,
  ...
  getStaff: async (params?: {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/staff?${queryParams.toString()}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  resetNotificationPreferences: async (): Promise<PreferencesResponse> => {
    try {
      ...
      if (!response.ok) {
        ...
        const errorData = await response.json().catch(() => ({}))
        throw new Error(
          errorData.error || 'Failed to reset notification preferences'
        )
      }
  ...
  previewNotificationTemplate: async (
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/templates/${key}/preview`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  async getArchivedNotifications(
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/notifications/archive?${searchParams}`,
        {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async getArchiveStats() {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/notifications/archive/stats`,
        {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async archiveNotification(id: number) {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/notifications/archive/${id}/archive`,
        {
          method: 'PUT',
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async archiveBulkNotifications(notificationIds: number[]) {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/notifications/archive/archive/bulk`,
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
  ...
  async restoreNotification(id: number) {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/notifications/archive/${id}/restore`,
        {
          method: 'PUT',
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async restoreBulkNotifications(notificationIds: number[]) {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/notifications/archive/restore/bulk`,
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
  ...
  async permanentDeleteNotification(id: number) {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/notifications/archive/${id}/permanent`,
        {
          method: 'DELETE',
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      if (!response.ok) {
        ...
        const errorData = await response.json().catch(() => ({}))
        throw new Error(
          errorData.error || 'Failed to delete notification permanently'
        )
      }
  ...
  async searchNotifications(
    ...
    try {
      ...
      if (options.includeArchived !== undefined)
        searchParams.append(
          'includeArchived',
          options.includeArchived.toString()
        )
      if (options.category) searchParams.append('category', options.category)
      if (options.priority) searchParams.append('priority', options.priority)
      if (options.startDate) searchParams.append('startDate', options.startDate)
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/notifications/archive/search?${searchParams}`,
        {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async getArchivalPolicies() {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/notifications/archival/policies`,
        {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async getArchivalStatus() {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/notifications/archival/status`,
        {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async triggerArchival() {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/notifications/archival/trigger`,
        {
          method: 'POST',
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async triggerCleanup() {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/notifications/archival/cleanup`,
        {
          method: 'POST',
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async startArchivalService() {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/notifications/archival/start`,
        {
          method: 'POST',
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async stopArchivalService() {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/notifications/archival/stop`,
        {
          method: 'POST',
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async getNextArchivalRuns() {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/notifications/archival/next-run`,
        {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${token}`,
