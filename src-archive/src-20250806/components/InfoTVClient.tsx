...
import { ZEITEN } from './home/map/zeiten'
...
import useDate from './info/useDate'
...
interface InfoTVClientProps {
  news: NewsItem[]
}

const InfoTVClient: React.FC<InfoTVClientProps> = ({ news }) => {
            ...
            <Grid item md={9}>
              ...
              >
                ...
                >
                  ...
                  >
                    <News header="Neuigkeiten" news={news} />
                  </Box>
                  <Box
                    sx={{
                      width: 'calc((100% - 96px) / 3)',
