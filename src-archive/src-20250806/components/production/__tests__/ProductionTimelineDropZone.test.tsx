...
describe('ProductionTimelineDropZone', () => {
  ...
  it('renders with time label', () => {
    renderWithTheme(<ProductionTimelineDropZone {...mockProps} />)
  ...
  it('handles drag over event correctly', () => {
    ...
    const dropZone = screen.getByTestId('AccessTimeIcon').closest('div')!
      .parentElement!
  ...
  it('applies correct styling based on drag state', () => {
    ...
    let dropZone = screen.getByTestId('AccessTimeIcon').closest('div')!
      .parentElement!
    ...
    dropZone = screen.getByTestId('AccessTimeIcon').closest('div')!
      .parentElement!
