    ...
    <Card>
      <CardContent>
          ...
          <Grid container spacing={2}>
            <Grid item xs={6} sm={3}>
              <Box textAlign="center" p={1} bgcolor="grey.50" borderRadius={1}>
                ...
                <Typography variant="caption">Gesamt Chargen</Typography>
              </Box>
            </Grid>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={6}>
            <Box>
              <Box display="flex" alignItems="center" mb={2}>
                ...
                <Box flex={1}>
                  <Typography variant="subtitle2">Gesamteffizienz</Typography>
                  <Typography variant="h5" color="primary">
                    {formatPercentage(metrics.efficiency.overall)}
                  </Typography>
                </Box>
                {showTrends && (
                  <Box textAlign="center">
                    ...
                    <Typography
                      variant="caption"
                      color={getTrendColor(metrics.trends.efficiency.trend)}
                    >
                      {metrics.trends.efficiency.change > 0 ? '+' : ''}
                      {formatPercentage(metrics.trends.efficiency.change)}
                    </Typography>
                  </Box>
                )}
              </Box>
              ...
              <Box mb={1}>
                <Box display="flex" justifyContent="space-between" mb={0.5}>
                  ...
                  <Typography variant="caption">
                    {formatPercentage(metrics.efficiency.production)}
                  </Typography>
                </Box>
                <LinearProgress
                  variant="determinate"
              ...
              <Box mb={1}>
                <Box display="flex" justifyContent="space-between" mb={0.5}>
                  ...
                  <Typography variant="caption">
                    {formatPercentage(metrics.efficiency.time)}
                  </Typography>
                </Box>
                <LinearProgress
                  variant="determinate"
              ...
              <Box>
                <Box display="flex" justifyContent="space-between" mb={0.5}>
                  ...
                  <Typography variant="caption">
                    {formatPercentage(metrics.efficiency.quality)}
                  </Typography>
                </Box>
                <LinearProgress
                  variant="determinate"
          ...
          <Grid item xs={12} md={6}>
            <Box>
              <Box display="flex" alignItems="center" mb={2}>
                <Avatar
                  sx={{ bgcolor: 'success.main', mr: 2, width: 32, height: 32 }}
                >
                ...
                {showTrends && (
                  <Box textAlign="center">
                    ...
                    <Typography
                      variant="caption"
                      color={getTrendColor(metrics.trends.quality.trend)}
                    >
                      {metrics.trends.quality.change > 0 ? '+' : ''}
                      {formatPercentage(metrics.trends.quality.change)}
                    </Typography>
                  </Box>
                )}
              </Box>
                ...
                <Grid item xs={4}>
                  ...
                  >
                    <Typography variant="body2" color="info.contrastText">
                      {formatPercentage(
                        metrics.quality.qualityCheckCompletionRate
                      )}
                    </Typography>
          ...
          <Grid item xs={12} md={6}>
            <Box>
              <Box display="flex" alignItems="center" mb={2}>
                <Avatar
                  sx={{ bgcolor: 'info.main', mr: 2, width: 32, height: 32 }}
                >
                  <Schedule fontSize="small" />
                </Avatar>
                <Box flex={1}>
                  <Typography variant="subtitle2">Zeitmanagement</Typography>
              ...
              <Grid container spacing={1}>
                <Grid item xs={4}>
                  ...
                  >
                    <CheckCircle
                      fontSize="small"
                      sx={{ mr: 1, color: 'success.contrastText' }}
                    />
                    <Box>
                      <Typography variant="body2" color="success.contrastText">
                ...
                <Grid item xs={4}>
                  ...
                  >
                    <Warning
                      fontSize="small"
                      sx={{ mr: 1, color: 'warning.contrastText' }}
                    />
                    <Box>
                      <Typography variant="body2" color="warning.contrastText">
                ...
                <Grid item xs={4}>
                  ...
                  >
                    <TrendingUp
                      fontSize="small"
                      sx={{ mr: 1, color: 'info.contrastText' }}
                    />
                    <Box>
                      <Typography variant="body2" color="info.contrastText">
              ...
              {metrics.timing.averageDelayMinutes > 0 && (
                <Box mt={1} p={1} bgcolor="warning.light" borderRadius={1}>
                  <Typography variant="caption" color="warning.contrastText">
                    ...
                    {Math.round(metrics.timing.averageDelayMinutes)} Minuten
                  </Typography>
                </Box>
              )}
            </Box>
          ...
          <Grid item xs={12} md={6}>
            <Box>
              <Box display="flex" alignItems="center" mb={2}>
                <Avatar
                  sx={{ bgcolor: 'warning.main', mr: 2, width: 32, height: 32 }}
                >
                  <Assessment fontSize="small" />
                </Avatar>
                <Box flex={1}>
                  <Typography variant="subtitle2">Durchsatz</Typography>
                  <Typography variant="h5" color="warning.main">
                    {formatNumber(
                      metrics.throughput.summary.averageBatchesPerPeriod
                    )}
                  </Typography>
                  <Typography variant="caption" color="text.secondary">
                    Chargen/Tag
                ...
                {showTrends && (
                  <Box textAlign="center">
                    ...
                    <Typography
                      variant="caption"
                      color={getTrendColor(metrics.trends.throughput.trend)}
                    >
                      {metrics.trends.throughput.change > 0 ? '+' : ''}
                      {formatPercentage(metrics.trends.throughput.change)}
                    </Typography>
                  </Box>
                )}
              </Box>
                ...
                <Grid item xs={6}>
                  ...
                  >
                    <Typography variant="body2" color="secondary.contrastText">
                      {formatNumber(
                        metrics.throughput.summary.averageQuantityPerPeriod
                      )}
                    </Typography>
                    <Typography
                      variant="caption"
        ...
        <Box mt={2} textAlign="center">
          <Typography variant="caption" color="text.secondary">
            Zeitraum:{' '}
            {format(new Date(metrics.period.start), 'dd.MM.yyyy', {
              locale: de,
            })}{' '}
            -
