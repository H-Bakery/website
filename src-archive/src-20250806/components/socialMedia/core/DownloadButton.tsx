  ...
  return (
    <Box sx={{ width: '100%', mt: 2 }}>
      ...
      >
        ...
        <DialogContent>
          <Typography variant="body1" paragraph>
            Wir verwenden einen neuen, zuverlässigeren Weg, um Ihr Social Media
            Bild zu erstellen. Sollte das Bild leer erscheinen:
          </Typography>
          <Stack spacing={2}>
            <Typography variant="body2" sx={{ mb: 2, fontWeight: 'bold' }}>
              Der Download sollte jetzt zuverlässig funktionieren. Wenn Sie
              dennoch ein leeres Bild sehen:
            </Typography>
            ...
            <Typography variant="body2">
              3. Als letzte Option: Erstellen Sie einen Screenshot der Vorschau
      ...
      <Dialog open={errorDialogOpen} onClose={() => setErrorDialogOpen(false)}>
        ...
        <DialogContent>
          <Typography variant="body1" paragraph>
            Es ist ein Fehler beim Erstellen des Bildes aufgetreten. Keine
            Sorge, Ihr Bild wurde trotzdem generiert:
          </Typography>
