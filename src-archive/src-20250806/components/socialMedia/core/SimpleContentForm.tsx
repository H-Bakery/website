...
const SimpleContentForm: React.FC<SimpleContentFormProps> = ({
  ...
  const contentConfig: Record<TemplateType, any> = {
    ...
    'bakery-news': {
      ...
      descriptionPlaceholder:
        'z.B. Ab nächster Woche haben wir auch sonntags für Sie geöffnet...',
    ...
    message: {
      ...
      additionalInfoPlaceholder:
        'Lassen Sie leer für roten Hintergrund oder "white" für weißen Hintergrund',
    ...
    'website-card': {
      ...
      descriptionLabel: 'Beschreibung',
      descriptionPlaceholder:
        'Von traditionellen Broten bis zu modernen Kreationen',
      descriptionMaxLength: 80,
      showPrice: false,
  ...
  const config = contentConfig[templateType] || {
    ...
    additionalInfoLabel: templateConfig.layout.formatHashtags
      ? 'Hashtags'
      : 'Zusätzliche Informationen',
    additionalInfoPlaceholder: templateConfig.layout.formatHashtags
      ? '#hashtag1 #hashtag2'
      : 'Zusätzliche Informationen...',
    ...
    >
      <Stack spacing={3}>
        ...
        <TextField
          ...
          required
          multiline={
            templateType === 'message' || templateType === 'simple-square'
          }
          rows={
            templateType === 'message' || templateType === 'simple-square'
              ? 5
