...
const dashboardKeys = {
  ...
  summary: (range: TimeRange) => [...dashboardKeys.all, 'summary', range] as const,
  ...
  timeSeries: (type: string, range: TimeRange) => [...dashboardKeys.all, 'timeSeries', type, range] as const,
  production: (range: TimeRange) => [...dashboardKeys.all, 'production', range] as const,
  financial: (range: TimeRange) => [...dashboardKeys.all, 'financial', range] as const,
  inventory: () => [...dashboardKeys.all, 'inventory'] as const,
  staff: () => [...dashboardKeys.all, 'staff'] as const,
}

// Hook for summary data
export const useSummaryData = (range: TimeRange): UseQueryResult<SummaryData, Error> => {
  return useQuery({
...
// Hook for sales data
export const useSalesData = (range: TimeRange): UseQueryResult<SalesData[], Error> => {
  return useQuery({
...
export const useProductionData = (range: TimeRange): UseQueryResult<ProductionData[], Error> => {
  return useQuery({
...
export const useFinancialData = (range: TimeRange): UseQueryResult<FinancialData[], Error> => {
  return useQuery({
