    ...
    >
      <Container maxWidth="lg">
        ...
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          ...
          >
            Entdecken Sie täglich neue Einblicke in unsere Backstube und lassen Sie sich inspirieren
          </Typography>
        </Box>
                ...
                >
                  ...
                  <Box
                    sx={{
                      ...
                      display: (imageLoading[post.id] || imageErrors[post.id]) ? 'block' : 'none',
                    }}
                  />
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                        ...
                        >
                          <FavoriteIcon 
                            sx={{ 
                              fontSize: 20,
                              color: likedPosts.includes(post.id) ? 'error.main' : 'white',
                              animation: likedPosts.includes(post.id) ? `${heartBeat} 0.8s ease` : 'none',
                            }} 
                          />
                        </IconButton>
