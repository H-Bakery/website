...
const SeasonalHighlights: React.FC = () => {
  ...
  const currentProducts = seasonalProducts.filter(p => p.season === currentSeason)
                ...
                <CardMedia
                  ...
                  sx={{
                    ...
                    '&::after': {
                      ...
                      right: 0,
                      bottom: 0,
                      background: `linear-gradient(180deg, transparent 60%, ${alpha(theme.palette.background.paper, 0.8)} 100%)`,
                    },
                  }}
                >
                  ...
                  <Box
                    sx={{
                      ...
                      fontSize: '4rem',
                      color: config.color,
                      background: `radial-gradient(circle at center, ${alpha(config.color, 0.1)} 0%, ${alpha(config.color, 0.05)} 100%)`,
                    }}
                  >
                    {config.icon}
                  </Box>
        ...
        >
          ...
          <EnhancedButton
            ...
            sx={{
              ...
              color: 'white',
              '&:hover': {
                background: `linear-gradient(45deg, ${config.color} 10%, ${alpha(config.color, 0.8)} 80%)`,
              },
            }}
          >
