    ...
    >
      ...
      <Container maxWidth="lg">
        <Box sx={{ textAlign: 'center', mb: 5 }}>
          ...
          >
            Qualität, Tradition und Leidenschaft – das macht uns seit Generationen aus
          </Typography>
        </Box>
              ...
              <Tooltip title={badge.description} arrow placement="top">
                <Paper
                  ...
                  sx={{
                    ...
                    animation: `${fadeIn} 0.6s ease-out ${index * 0.1}s both, ${float} 3s ease-in-out ${index * 0.5}s infinite`,
                    '&:hover': {
