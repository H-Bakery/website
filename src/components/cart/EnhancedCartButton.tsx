    ...
    <>
      ...
      <Zoom in={totalCount > 0}>
        <Fab
          ...
          sx={{
            position: 'fixed',
            bottom: { xs: 'calc(80px + env(safe-area-inset-bottom))', sm: 32, md: 32 },
            right: { xs: 16, sm: 24, md: 32 },
            zIndex: 1100, // Below bottom nav (1200) but above content
            width: { xs: 56, md: 64 },
            height: { xs: 56, md: 64 },
            animation: isAnimating ? `${shake} 0.5s ease, ${pulse} 1.5s ease` : undefined, // Removed continuous bounce animation
