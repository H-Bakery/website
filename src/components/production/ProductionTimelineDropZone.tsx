...
export const ProductionTimelineDropZone: React.FC<ProductionTimelineDropZoneProps> = ({
  timeSlot,
  scheduleDate,
  scheduleStartTime,
  scheduleEndTime,
  ...
  const checkConflicts = useCallback((startTime: Date, duration: number) => {
      ...
      {isHovered && dropPreview && (
        ...
        >
          <Typography variant="caption" fontWeight="bold">
            {dropPreview.conflicts ? 'Konflikt!' : `${dropPreview.duration} Min`}
          </Typography>
        </Box>
      )}
        ...
        <>
          ...
          {dropPreview && !dropPreview.conflicts && (
            ...
            >
              ...
              >
                {format(timeSlot, 'HH:mm')} - {format(addMinutes(timeSlot, dropPreview.duration), 'HH:mm')}
              </Typography>
            </Box>
          )}
        </>
