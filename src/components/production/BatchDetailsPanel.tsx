      ...
      <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
        <DialogContent>
          <Alert severity="error">
            Fehler beim Laden der Batch-Details: {(batchError as any)?.message || (stepsError as any)?.message}
          </Alert>
        </DialogContent>
        <DialogActions>
  ...
  return (
    <>
          ...
          <Box display="flex" justifyContent="space-between" alignItems="center">
            <Box>
              ...
              <Box display="flex" gap={1} mt={1}>
                ...
                />
                <Chip
                  label={`${batch.actualQuantity || batch.plannedQuantity} ${batch.unit}`}
                  size="small"
                  variant="outlined"
                />
              </Box>
                ...
                <CardContent>
                  ...
                  <Box mb={2}>
                    <Box display="flex" justifyContent="space-between" mb={1}>
                      ...
                      <Typography variant="body2">{batch.progress || 0}%</Typography>
                    </Box>
                    <LinearProgress 
                      variant="determinate" 
                  ...
                  <Box mb={2}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Geplant: {format(parseISO(batch.plannedStartTime), 'HH:mm', { locale: de })} - 
                      {format(parseISO(batch.plannedEndTime), 'HH:mm', { locale: de })}
                    </Typography>
                    {batch.actualStartTime && (
                      <Typography variant="body2" color="text.secondary">
                        Tatsächlich: {format(parseISO(batch.actualStartTime), 'HH:mm', { locale: de })} - 
                        {batch.actualEndTime ? format(parseISO(batch.actualEndTime), 'HH:mm', { locale: de }) : 'läuft'}
                      </Typography>
                    )}
                    {batch.isDelayed && (
                          ...
                          <Box display="flex" justifyContent="space-between" alignItems="center" width="100%">
                            <Box>
                              ...
                              <Typography variant="caption" color="text.secondary">
                                {step.stepType} • {step.plannedDurationMinutes} min
                              </Typography>
                            </Box>
      ...
      <Dialog open={progressDialogOpen} onClose={() => setProgressDialogOpen(false)} maxWidth="sm" fullWidth>
        ...
        <DialogActions>
          <Button onClick={() => setProgressDialogOpen(false)}>Abbrechen</Button>
          <Button onClick={submitProgressUpdate} variant="contained">Speichern</Button>
        </DialogActions>
      </Dialog>
      ...
      <Dialog open={qualityDialogOpen} onClose={() => setQualityDialogOpen(false)} maxWidth="md" fullWidth>
                      ...
                      <Box flex={1}>
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setQualityData({ ...qualityData, checks: newChecks })
                          }}
                          style={{ width: '100%' }}
                        />
                      </Box>
        ...
        <DialogActions>
          ...
          <Button onClick={submitQualityCheck} variant="contained">Qualitätskontrolle speichern</Button>
        </DialogActions>
      </Dialog>
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  label="Schweregrad"
                  onChange={(e) => setIssueData({ ...issueData, severity: e.target.value as any })}
                >
            ...
            <Grid item xs={12}>
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  label="Auswirkung"
                  onChange={(e) => setIssueData({ ...issueData, impact: e.target.value as any })}
                >
