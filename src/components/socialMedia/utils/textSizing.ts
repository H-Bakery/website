...
export function calculateOptimalFontSize(
  ...
  if (totalTextHeight > maxHeight) {
    ...
    const adjustedCharactersPerLine = estimateCharactersPerLine(adjustedFontSize, maxWidth)
    const adjustedEstimatedLines = Math.ceil(textLength / adjustedCharactersPerLine)
