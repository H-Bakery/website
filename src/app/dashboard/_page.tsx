...
const Dashboard: React.FC = () => {
  ...
  // Define logout first since fetchChatMessages depends on it
  const logout = useCallback(() => {
    localStorage.removeItem('token')
    router.push('/login')
  }, [router])

  // Now define fetchChatMessages with logout as a dependency
