...
import CashEntryForm from '../../../components/admin/cash/CashEntryForm'
import CashHistoryTable from '../../../components/admin/cash/CashHistoryTable'
import MonthlySummary from '../../../components/admin/cash/MonthlySummary'
import EditCashEntryModal from '../../../components/admin/cash/EditCashEntryModal'
import DeleteCashEntryDialog from '../../../components/admin/cash/DeleteCashEntryDialog'
import bakeryAPI from '../../../services/bakeryAPI'
import { CashEntry } from '../../../services/types'
import { useRouter } from 'next/navigation'
import { cashCalculations, errorUtils } from '../../../utils/cashUtils'
...
const CashManagement: React.FC = () => {
  ...
  const handleUpdateEntry = async (id: number, amount: number, date: string) => {
    try {
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Paper sx={{ width: '100%' }}>
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          <Tabs value={tabValue} onChange={handleTabChange} aria-label="cash management tabs">
            <Tab label="Kassenstand eingeben" id="cash-tab-0" aria-controls="cash-tabpanel-0" />
            <Tab label="Kassenverlauf" id="cash-tab-1" aria-controls="cash-tabpanel-1" />
            <Tab label="Monatsübersicht" id="cash-tab-2" aria-controls="cash-tabpanel-2" />
          </Tabs>
        </Box>
