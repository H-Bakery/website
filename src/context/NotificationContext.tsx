    ...
    if (token) {
      ...
      const unsubscribeNew = socketService.onNewNotification((notification) => {
        ...
        if (preferences) {
          ...
          const categoryEnabled = preferences.categoryPreferences[notification.category] ?? true;
          
          // Check priority threshold
          const priorityOrder = { low: 0, medium: 1, high: 2, urgent: 3 };
          const meetsThreshold = priorityOrder[notification.priority] >= priorityOrder[preferences.priorityThreshold];
          ...
          if (preferences.browserEnabled && categoryEnabled && meetsThreshold && !inQuietHours &&
        ...
        setNotifications(prev => {
          ...
          if (deleted && stats) {
            setStats({
              ...
              byPriority: {
                ...stats.byPriority,
                [deleted.priority]: Math.max(0, (stats.byPriority[deleted.priority] || 0) - 1),
              },
            });
          }
