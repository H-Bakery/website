...
export const productionQueryKeys = {
  ...
  batchSteps: (batchId: number) =>
    [...productionQueryKeys.batch(batchId), 'steps'] as const,
...
export function useDeleteSchedule() {
  ...
  return useMutation((id: number) => productionAPI.deleteSchedule(id), {
    onSuccess: () => {
      queryClient.invalidateQueries(productionQueryKeys.schedules())
    },
  })
...
export function useStartBatch() {
  ...
  return useMutation((id: number) => productionAPI.startBatch(id), {
    onSuccess: (_, id) => {
      queryClient.invalidateQueries(productionQueryKeys.batch(id))
      queryClient.invalidateQueries(productionQueryKeys.batches())
      queryClient.invalidateQueries(productionQueryKeys.status())
...
export function useDeleteBatch() {
  ...
  return useMutation((id: number) => productionAPI.deleteBatch(id), {
    onSuccess: () => {
      queryClient.invalidateQueries(productionQueryKeys.batches())
      queryClient.invalidateQueries(productionQueryKeys.status())
    },
...
export function useResumeBatch() {
  ...
  return useMutation((batchId: number) => productionAPI.resumeBatch(batchId), {
    onSuccess: () => {
      queryClient.invalidateQueries(productionQueryKeys.status())
      queryClient.invalidateQueries(productionQueryKeys.batches())
    },
