...
export const ResourceOptimizationPanel: React.FC<
  ResourceOptimizationPanelProps
> = ({ selectedDate, onOptimizationComplete }) => {
    ...
    try {
      ...
      const result = await optimizeScheduleMutation.mutateAsync({
        ...
        productionDemand: [
          {
            productId: 1,
            workflowId: 'sourdough_bread',
            quantity: 50,
            priority: 'high',
          },
          {
            productId: 2,
            workflowId: 'croissant',
            quantity: 100,
            priority: 'medium',
          },
          {
        ...
        recommendations: [
          {
            ...
            description:
              'Sauerteigbrot und Croissants können parallel produziert werden',
          ...
          },
          {
            ...
            description:
              'Ein Bäcker von Station 2 zu Station 1 verlegen für bessere Auslastung',
          ...
          },
          {
            ...
            description:
              'Ofen 2 kann für kleinere Chargen effizienter genutzt werden',
    ...
    <>
      <Card>
        <CardContent>
          ...
          >
            <Box>
              <Typography variant="h6">Ressourcen-Optimierung</Typography>
                ...
                <List>
                  {constraints.map((constraint, index) => (
                    <ListItem key={index}>
                      ...
                      <ListItemSecondaryAction>
                        <IconButton
                          onClick={() => handleConstraintToggle(index)}
                        >
                          {constraint.enabled ? (
                  ...
                  <Box>
                    {optimizationResult.success ? (
                      ...
                      <Alert severity="error">
                        Optimierung fehlgeschlagen. Bitte versuchen Sie es
                        erneut.
                      </Alert>
                    )}
                  </Box>
