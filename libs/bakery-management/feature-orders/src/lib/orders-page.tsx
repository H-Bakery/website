...
import { Button, DataTable } from '@bakery/shared/ui'
import { bakeryAPI } from '@bakery/shared/data-access'
import { Product, Order, OrderItem } from '@bakery/shared/types'
import OrderForm from './order-form'
import QuickOrderForm from './quick-order-form'
import WeeklyCalendar from './weekly-view/WeeklyCalendar'
import OrderDetailDialog from './weekly-view/OrderDetailDialog'
