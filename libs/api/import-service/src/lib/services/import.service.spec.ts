...
describe('ImportService', () => {
  ...
  describe('checkDuplicateReport', () => {
    ...
    it('should throw error if service not initialized', async () => {
      ...
      await expect(importService.checkDuplicateReport('2024-01-15'))
  ...
  describe('processReport', () => {
    ...
    beforeEach(() => {
      ...
      (validationService.validateReportData as jest.Mock).mockResolvedValue(undefined);
    ...
    it('should rollback transaction on validation error', async () => {
      ...
      await expect(importService.processReport(mockReport))
    ...
    it('should rollback transaction if user not found', async () => {
      ...
      await expect(importService.processReport(mockReport))
        .rejects.toThrow('User not found: john.doe');
    ...
    it('should rollback transaction if product not found', async () => {
      ...
      await expect(importService.processReport(mockReport))
        .rejects.toThrow('Product not found: 1 (Croissant)');
  ...
  describe('processBulkReports', () => {
    ...
    it('should process multiple reports and skip duplicates', async () => {
      ...
      importService.checkDuplicateReport = jest.fn()
    ...
    it('should handle processing errors gracefully', async () => {
      ...
      importService.processReport = jest.fn()
