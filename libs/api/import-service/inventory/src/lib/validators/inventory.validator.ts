 ...
 */
export const inventoryCreationRules = (): ValidationChain[] => [
  body('name')
    .trim()
    .escape()
 ...
 */
export const inventoryUpdateRules = (): ValidationChain[] => [
  param('id')
 ...
 */
export const inventoryDeleteRules = (): ValidationChain[] => [
  param('id')
    .notEmpty().withMessage('Inventory item ID is required')
    .isInt({ min: 1 }).withMessage('Inventory item ID must be a positive integer')
];
 ...
 */
export const stockAdjustmentRules = (): ValidationChain[] => [
  param('id')
    .notEmpty().withMessage('Inventory item ID is required')
    .isInt({ min: 1 }).withMessage('Inventory item ID must be a positive integer'),
 ...
 */
export const bulkStockAdjustmentRules = (): ValidationChain[] => [
  body('adjustments')
