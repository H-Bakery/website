...
/**
 * Enhanced button props extending Material UI ButtonProps
 * @interface EnhancedButtonProps
 */
export interface EnhancedButtonProps extends MuiButtonProps {
...
/**
 * Enhanced button component with animations and advanced styling
 * @component
 * @example
 * ```tsx
